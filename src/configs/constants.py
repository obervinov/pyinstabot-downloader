...
QUEUE_FREQUENCY = os.environ.get('TELEGRAM_BOT_QUEUE_FREQUENCY', 60)
STATUSES_MESSAGE_FREQUENCY = os.environ.get('TELEGRAM_BOT_STATUSES_MESSAGE_FREQUENCY', 15)
METRICS_PORT = os.environ.get('TELEGRAM_BOT_METRICS_PORT', 8000)
METRICS_INTERVAL = os.environ.get('TELEGRAM_BOT_METRICS_INTERVAL', 30)
